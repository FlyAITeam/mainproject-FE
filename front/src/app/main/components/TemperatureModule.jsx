  ...
  return (
    ...
    >
      <div className="w-full h-fit flex flex-row justify-between items-center space-x-4">
        <div className="w-fit pl-2 h-fit relative ">
          <svg
        ...
        <div className="w-full pl-4 h-fit flex flex-col space-y-2 justify-start items-start">
          <motion.p
            className={classNames(
              "w-fit flex text-sm  px-4 py-1 rounded-lg font-semibold text-white",
              temperature < 37
                ? "bg-deepblue"
                : temperature < 39
                  ? "bg-green"
          ...
          <p className="w-fit text-xs text-grayText break-keep">
            {temperature < 37
